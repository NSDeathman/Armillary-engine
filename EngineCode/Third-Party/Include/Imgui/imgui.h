...
struct ImFontConfig
{
	...
	ImVec2 GlyphExtraSpacing; // 0, 0     // Extra spacing (in pixels) between glyphs when rendered: essentially add to
...
struct ImFont
{
	...
	const ImFontConfig* ConfigData; // 4-8   // in  //            // Pointer within ContainerAtlas->ConfigData to
									// ConfigDataCount instances
